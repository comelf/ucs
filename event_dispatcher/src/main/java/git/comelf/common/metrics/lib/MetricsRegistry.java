...
public class MetricsRegistry {
    private final Map<String, MutableMetric> metricsMap = new LinkedHashMap();
    private final Map<String, MetricsTag> tagsMap = new LinkedHashMap();
...
//            }
//            else {
//                throw new RuntimeException("Unsupported add(value) for metric "+ name);
//            }
//        }
//        else {
...
//    }
    ...
    private void checkMetricName(String name) {
        ...
        if (foundWhitespace) {
            throw new RuntimeException("Metric name '"+ name +
                    "' contains illegal whitespace character");
        }
        // Check if name has already been registered
        if (metricsMap.containsKey(name)) {
            throw new RuntimeException("Metric name "+ name +" already exists!");
        }
    }
    ...
    public String toString() {
        ...
        sb.append("}");
        sb.append(" info=");
        sb.append(metricsInfo.toString());
        sb.append(", tags=");
        sb.append(tags());
        sb.append(", metrics=");
        sb.append(metrics());
